...
print2:		.string	"product = 0x08%x multiplier = 0x%08x\n"		 //print value of product and multiplier
...
main:		stp	x29, x30, [sp, -16]!
		...
		//Intialize vars
		mov	mand, 522133279		//assign value of multiplicand to be 522133279
		mov	mult, 200		//assign value of multiplier to be 200
...
up_m:		lsr	mult, mult, 1		//multiplier = multiplier >> 1
...
end:		adrp	x0, print2		// move print statement to x0
		add	x0, x0, :lo12:print2	//magic
		mov	w1, prod		// move product to w1
		mov	w2, mult		// move multiplier to w2
		bl	printf			//print
